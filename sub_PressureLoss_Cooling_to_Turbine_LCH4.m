function [properties, key_values] = sub_PressureLoss_Cooling_to_Turbine_LCH4(inputs, properties)

    D   = inputs.D_Cooling_Outlet_to_Turbine;
    A   = (D/2)^2 * pi;
    L   = inputs.L_Cooling_Outlet_to_Turbine;

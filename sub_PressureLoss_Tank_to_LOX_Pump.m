function [properties, key_values] = sub_PressureLoss_Tank_to_LOX_Pump(inputs, properties)

    D   = inputs.D_Tank_to_LOX_Pump;
    A   = (D/2)^2 * pi;
    L   = inputs.L_Tank_to_Pump;
    K   = 0.8;          % Combined minor-loss coefficient for oxidizer feedline bends, valves, and control-system losses only

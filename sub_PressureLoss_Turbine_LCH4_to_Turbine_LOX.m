function [properties, key_values] = sub_PressureLoss_Turbine_LCH4_to_Turbine_LOX(inputs, properties)

    D   = inputs.D_TurbineCH4_to_TurbineOx;
    A   = (D/2)^2 * pi;
    L   = inputs.L_TurbineCH4_to_TurbineOx;
    K   = 0.8;         % Geometry Constant
